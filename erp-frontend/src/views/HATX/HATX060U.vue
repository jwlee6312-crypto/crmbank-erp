<!--	=============================================================
	?ÑÎ°úÍ∑∏Îû®Î™?: Îß§Ï∂úÎ∂ÄÍ∞Ä?∏Ï†ë??
	?ëÏÑ±?ºÏûê: 2025.02.24
	?ëÏÑ±??    : AI Assistant
	?§Î™Ö        : Îß§Ï∂ú Î∂ÄÍ∞Ä???¥Ïó≠???ëÏàò ?ïÏù∏ Î∞??ÑÏûêÎ∞úÌñâ ?¨Î? ?ºÍ¥Ñ Í¥ÄÎ¶?
	=============================================================
-->
	...
	<div class="erp-container">
		<div class="erp-header d-flex justify-content-between align-items-center border-bottom bg-white py-2 px-3 sticky-top shadow-sm flex-shrink-0">
			<div class="fw-bold text-dark d-flex align-items-center" style="font-size: 14px;">
				...
				<span class="text-primary fw-bolder">Îß§Ï∂úÎ∂ÄÍ∞Ä?∏Ï†ë??(HATX060U)</span>
			</div>
			...
			<div class="card border shadow-sm bg-white overflow-hidden">
				<div class="card-body p-2 bg-light">
					<div class="d-flex align-items-center flex-wrap gap-3">
						...
						<div class="d-flex align-items-center">
							<span class="erp-label">Î∞úÌñâ??/span>
						...
						<div class="d-flex align-items-center">
							<span class="erp-label">Ï°∞Ìöå?Ä??/span>
