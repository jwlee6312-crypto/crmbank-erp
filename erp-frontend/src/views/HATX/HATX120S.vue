	...
	if (summaryGridRef.value) {
		summaryGrid = new Tabulator(summaryGridRef.value, {
			...
			columns: [
				...
				{ title: `매입처수`, field: "count", width: 150, hozAlign: "right", formatter: "money", formatterParams: { precision: 0 } },
				{ title: "매수", field: "sheets", width: 150, hozAlign: "right", formatter: "money", formatterParams: { precision: 0 } },
				{ title: `매입금액`, field: "amount", width: 200, hozAlign: "right", formatter: "money", formatterParams: { precision: 0 } }
			]
		})
	}
	...
	if (mainGridRef.value) {
		mainGrid = new Tabulator(mainGridRef.value, {
			...
			columns: [
				...
				{ title: `매입금액`, field: "amt", width: 130, hozAlign: "right", formatter: "money", formatterParams: { precision: 0 } }
			]
		})
	}
	updateGridTitles()
