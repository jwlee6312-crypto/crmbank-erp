...
<template>
	...
	<div class="hsio730u-wrapper d-flex flex-column h-100 bg-white p-0">
		<!-- 🚀 1. 상단 액션 바 (표준 버튼 배치) -->
		<div class="erp-header d-flex justify-content-between align-items-center border-bottom bg-white py-2 px-3 sticky-top shadow-sm">
			...
			<div class="btn-group-erp d-flex gap-1">
				...
				<button class="btn-erp btn-danger" @click="handleDelete" :disabled="!formData.IONO">삭제</button>
			</div>
		</div>
		...
		<div class="erp-footer bg-dark text-white py-2 px-4 shadow-lg sticky-bottom">
			<div class="row align-items-center w-100">
				...
				<div class="col-md-9 text-end">
					<span class="fs-5 ms-2 fw-light">선택 총 해체수량: <span class="fw-bold text-white ms-2">{{ formatNumber(totalSummary) }}</span></span>
				</div>
			</div>
		</div>
	</div>
