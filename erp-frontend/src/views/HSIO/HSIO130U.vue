<!--
	...
	작성일자	: 25.02.24
	작성자	    : AI Assistant
	설명        : [표준화] ASP(HSIO_130U) 기반 재작성 - 단일 그리드, 요약바 제거, 팝업 표준화
	=============================================================
-->
    ...
    <div class="flex-grow-1 d-flex flex-column overflow-hidden p-2 gap-2">
              ...
              <tr class="bg-light-subtle">
                ...
                <td>
                  <div class="form-check form-switch m-0 d-flex align-items-center">
                    ...
                    <label class="form-check-label ms-2 small fw-bold" for="cardCheck">카드 결제</label>
                  </div>
                </td>
                <th>카드번호</th>
                <td colspan="3">
      ...
      <div class="card border shadow-sm flex-grow-1 overflow-hidden d-flex flex-column bg-white">
        <div class="card-header bg-white py-1 px-3 border-bottom d-flex align-items-center justify-content-between">
          <span class="fw-bold small text-dark"><i class="bi bi-grid-3x3-gap-fill me-2 text-primary"></i> 전표 발행 대상 내역</span>
  ...
  if (mainGridRef.value) {
    grid = new Tabulator(mainGridRef.value, {
      ...
      columns: [
        ...
        { title: '합계', field: 'JSANSUM', width: 120, hozAlign: 'right', formatter: 'money', cssClass: 'bg-light fw-bold', mutatorData: (v, d) => Number(d.JSANAMT || 0) + Number(d.JSANVAT || 0) },
...
<style scoped>
.hsio130u-wrapper { height: 100%; overflow: hidden; font-family: 'Pretendard', sans-serif; }
