...
<style scoped>
.hsio052u-wrapper { height: 100%; overflow: hidden; }
...
.erp-table-full td { vertical-align: middle; padding: 6px 10px !important; border: 1px solid #dee2e6 !important; background-color: #fff; }
