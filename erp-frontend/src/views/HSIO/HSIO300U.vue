...
<style scoped>
.hsio300u-wrapper { height: 100%; overflow: hidden; font-family: 'Pretendard', sans-serif; background-color: #f4f7fa !important; }
...
:deep(.tabulator) { border: none !important; font-size: 12px; }
:deep(.tabulator-header) { background-color: #f8f9fa !important; border-bottom: 2px solid #dee2e6 !important; }
:deep(.tabulator-col) { background-color: #f8f9fa !important; font-weight: 700 !important; color: #495057 !important; border-right: 1px solid #dee2e6 !important; height: 40px !important; }
