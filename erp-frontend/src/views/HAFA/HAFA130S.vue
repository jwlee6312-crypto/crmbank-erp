<!--	=============================================================
	...
	작성일자	: 2025.02.24
	작성자	    : AI Assistant
	설명        : 부서별/계정과목별 감가상각비 발생 현황 집계 조회 (표준 디자인 및 집계 콤마 적용)
	=============================================================
-->
...
async function search() {
	try {
		...
		mainGrid?.setData(normalizeKeys(res.data || [])); vAlert('조회되었습니다.')
	...
	if (mainGridRef.value) {
		mainGrid = new Tabulator(mainGridRef.value, {
			...
			columns: [
				...
				{
                    title: "당기증가", field: "incramt", hozAlign: "right", formatter: "money", formatterParams: { precision: 0 },
                    bottomCalc: "sum", bottomCalcFormatter: "money", bottomCalcFormatterParams: { precision: 0 }
                },
				{
