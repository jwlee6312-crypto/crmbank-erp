  ...
  <div class="hspl220s-wrapper d-flex flex-column h-100 bg-white p-0">
    ...
    <div class="erp-footer bg-dark text-white py-2 px-4 shadow-lg sticky-bottom">
      <div class="row align-items-center text-center">
        <div class="col-md-12 small opacity-75">
          ※ 각 사원별로 [계획 / 실적 / 달성율] 순으로 표시됩니다. 사원명을 클릭하면 상세 품목 실적(HSPL200S)으로 이동합니다.
        </div>
      </div>
    </div>
    ...
    columns: [
      {
        ...
        cellClick: (e, cell) => {
            ...
            if (data.TYPE === '계획' && !data.IS_TOTAL && data.USERID) {
                // Navigate to HSPL200S with parameters
                router.push({
                    name: '품목별판매계획대실적', // Ensure this matches the name in your routes
