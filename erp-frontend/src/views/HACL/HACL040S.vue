<!--
	=============================================================
	?„ë¡œê·¸ë¨ëª?: ?œì¡°?ê?ëª…ì„¸??(HACL040S)
	?‘ì„±?¼ì	: 2025.02.24
	?¤ëª…        : HSOD100U ?œì? ê·¸ë¦¬???¨í„´??ì¤€?˜í•˜???œì¡°?ê?ëª…ì„¸??ì¡°íšŒ
	=============================================================
-->
  ...
  <div class="erp-container d-flex flex-column h-100 bg-white">
    ...
    <div class="erp-header d-flex justify-content-between align-items-center flex-shrink-0 border-bottom">
      <div class="fw-bold ps-1 text-dark d-flex align-items-center" style="font-size: 14px;">
        ...
        <span class="text-primary fw-bolder">?œì¡°?ê?ëª…ì„¸??(HACL040S)</span>
      </div>
...
const initGrid = () => {
  ...
  grid = new Tabulator(tableRef.value, {
    ...
    columns: [
      {
        title: "ê³? ëª?, field: "formatted_nm", widthGrow: 2,
        formatter: "html",
      ...
      },
      {
        title: "??     ê¸?,
        columns: [
          { title: "ê¸? ??, field: "camt", width: 200, hozAlign: "right", formatter: "money", formatterParams: { precision: 0 } },
      ...
      },
      {
        title: "??     ê¸?,
        columns: [
          { title: "ê¸? ??, field: "bamt", width: 200, hozAlign: "right", formatter: "money", formatterParams: { precision: 0 }, cssClass: "border-start" },
...
const excel = () => grid?.download("xlsx", `?œì¡°?ê?ëª…ì„¸??${searchForm.yy}${searchForm.mm}.xlsx`)
