<!--
	=============================================================
	?ÑÎ°úÍ∑∏Îû®Î™?: ?êÏùµÍ≥ÑÏÇ∞???πÏõî) (HACL050S)
	?ëÏÑ±?ºÏûê	: 2025.02.24
	?§Î™Ö        : HSOD100U ?úÏ? Í∑∏Î¶¨???®ÌÑ¥ ?ÅÏö© (?êÎ£å Íπ®Ïßê Î∞©Ï? Î∞??ïÎ†¨ ÏµúÏ†Å??
	=============================================================
-->
  ...
  <div class="erp-container d-flex flex-column h-100 bg-white">
    ...
    <div class="erp-header d-flex justify-content-between align-items-center flex-shrink-0 border-bottom">
      <div class="fw-bold ps-1 text-dark d-flex align-items-center" style="font-size: 14px;">
        ...
        <span class="text-primary fw-bolder">?êÏùµÍ≥ÑÏÇ∞???πÏõî) (HACL050S)</span>
      </div>
...
const initGrid = () => {
  ...
  grid = new Tabulator(tableRef.value, {
    ...
    columns: [
      {
        title: "Í≥? Î™?, field: "formatted_nm", widthGrow: 1.8,
        formatter: "html",
      ...
      },
      {
        title: "?ÑÏõî?ÑÍ≥Ñ",
        columns: [
          { title: "Í∏? ??, field: "bamt", width: 140, hozAlign: "right", formatter: "money", formatterParams: { precision: 0 } },
      ...
      },
      {
        title: "?? ??,
        columns: [
          { title: "Í∏? ??, field: "camt", width: 140, hozAlign: "right", formatter: "money", formatterParams: { precision: 0 }, cssClass: "bg-light-subtle fw-bold" },
      ...
      },
      {
        title: "?? Í≥?,
        columns: [
          { title: "Í∏? ??, field: "tamt", width: 140, hozAlign: "right", formatter: "money", formatterParams: { precision: 0 } },
...
const excel = () => grid?.download("xlsx", `?êÏùµÍ≥ÑÏÇ∞???πÏõî_${searchForm.yy}${searchForm.mm}.xlsx`)
