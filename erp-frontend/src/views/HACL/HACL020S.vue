<!--
	=============================================================
	?ÑÎ°úÍ∑∏Îû®Î™?: ?ÄÏ∞®Î?Ï°∞Ìëú (HACL020S)
	?ëÏÑ±?ºÏûê	: 2025.02.24
	?§Î™Ö        : HSOD100U ?úÏ? Í∑∏Î¶¨???ïÏùòÎ•?Ï§Ä?òÌïò???ÄÏ∞®Î?Ï°∞Ìëú Ï°∞Ìöå
	=============================================================
-->
  ...
  <div class="erp-container d-flex flex-column h-100 bg-white">
    ...
    <div class="erp-header d-flex justify-content-between align-items-center flex-shrink-0 border-bottom">
      <div class="fw-bold ps-1 text-dark d-flex align-items-center" style="font-size: 14px;">
        ...
        <span class="text-primary fw-bolder">?ÄÏ∞®Î?Ï°∞Ìëú (HACL020S)</span>
      </div>
  ...
  grid = new Tabulator(tableRef.value, {
    ...
    columns: [
      ...
      },
      {
        title: "??     Í∏?,
        columns: [
          { title: "Í∏? ??, field: "camtl", width: 160, hozAlign: "right", formatter: "money", formatterParams: { precision: 0 } },
          { title: "?? Í≥?, field: "camtr", width: 160, hozAlign: "right", formatter: "money", formatterParams: { precision: 0 }, cssClass: "fw-bold border-start bg-light-subtle" },
      ...
      },
      {
        title: "??     Í∏?,
        columns: [
          { title: "Í∏? ??, field: "bamtl", width: 160, hozAlign: "right", formatter: "money", formatterParams: { precision: 0 }, cssClass: "border-start" },
          { title: "?? Í≥?, field: "bamtr", width: 160, hozAlign: "right", formatter: "money", formatterParams: { precision: 0 }, cssClass: "fw-bold border-start bg-light-subtle" },
...
const excel = () => grid?.download("xlsx", `?ÄÏ∞®Î?Ï°∞Ìëú_${searchForm.yy}${searchForm.mm}.xlsx`)
const print = () => window.open(`/api/hacl/HACL_020P?yy=${searchForm.yy}&mm=${searchForm.mm}&PRTGU=1`)

const excel = () => grid?.download("xlsx", `?ÄÏ∞®Î?Ï°∞Ìëú_${searchForm.yy}_${searchForm.mm}.xlsx`)
