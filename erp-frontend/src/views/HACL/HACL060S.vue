<!--
	=============================================================
	?„ë¡œê·¸ë¨ëª?: ?œì¡°?ê?ëª…ì„¸???¹ì›”) (HACL060S)
	?‘ì„±?¼ì	: 2025.02.24
	?¤ëª…        : HSOD100U ?œì? ê·¸ë¦¬???•ì˜ë¥?ì¤€?˜í•˜???œì¡°?ê?ëª…ì„¸???„ì›”, ?¹ì›”, ?„ê³„) ì¡°íšŒ
	=============================================================
-->
  ...
  <div class="erp-container d-flex flex-column h-100 bg-white">
    ...
    <div class="erp-header d-flex justify-content-between align-items-center flex-shrink-0 border-bottom">
      <div class="fw-bold ps-1 text-dark d-flex align-items-center" style="font-size: 14px;">
        ...
        ?¬ë¬´?œí‘œ <i class="bi bi-chevron-right mx-1 small opacity-50"></i>
        <span class="text-primary fw-bolder">?œì¡°?ê?ëª…ì„¸???¹ì›”) (HACL060S)</span>
      </div>
        ...
        <div class="card-body p-2 bg-white">
          <div class="d-flex align-items-center gap-3 small">
            <div class="d-flex align-items-center">
              <span class="erp-label" style="min-width: 70px;"><i class="bi bi-dot text-primary"></i>?Œê³„?¼ì</span>
              <div class="d-flex align-items-center gap-1">
                ...
                <span class="ms-1 fw-bold">??ê¹Œì?</span>
              </div>
            </div>
          </div>
        </div>
...
const initGrid = () => {
  ...
  grid = new Tabulator(tableRef.value, {
    ...
    columns: [
      {
        title: "ê³? ëª?, field: "formatted_nm", widthGrow: 1.5,
        formatter: "html",
      ...
      },
      {
        title: "?„ì›”?„ê³„",
        columns: [
          { title: "ê¸? ??, field: "bamt", width: 200, hozAlign: "right", formatter: "money", formatterParams: { precision: 0 } },
      ...
      },
      {
        title: "?? ??,
        columns: [
          { title: "ê¸? ??, field: "camt", width: 200, hozAlign: "right", formatter: "money", formatterParams: { precision: 0 }, cssClass: "bg-light-subtle fw-bold" },
      ...
      },
      {
        title: "?? ê³?,
        columns: [
          { title: "ê¸? ??, field: "tamt", width: 200, hozAlign: "right", formatter: "money", formatterParams: { precision: 0 } },
...
const excel = () => grid?.download("xlsx", `?œì¡°?ê?ëª…ì„¸???¹ì›”_${searchForm.yy}${searchForm.mm}.xlsx`)
