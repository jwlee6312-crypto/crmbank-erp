<!--
	...
	작성일자	: 2025.02.24
	작성자	    : AI Assistant
	설명        : HSOD100U 표준 그리드 정의를 따른 손익계산서 조회
	=============================================================
-->
    ...
    columns: [
      ...
      },
      {
        ...
        columns: [
          ...
          { title: "소  계", field: "camtr", width: 160, hozAlign: "right", formatter: "money", formatterParams: { precision: 0 }, cssClass: "bg-light-subtle fw-bold" },
      ...
      },
      {
        ...
        columns: [
          ...
          { title: "소  계", field: "bamtr", width: 160, hozAlign: "right", formatter: "money", formatterParams: { precision: 0 }, cssClass: "bg-light-subtle fw-bold" },
