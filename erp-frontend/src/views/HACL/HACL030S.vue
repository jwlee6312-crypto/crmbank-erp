<!--
	=============================================================
	?ÑÎ°úÍ∑∏Îû®Î™?: ?êÏùµÍ≥ÑÏÇ∞??(Income Statement)
	?ëÏÑ±?ºÏûê	: 2025.02.24
	?ëÏÑ±??    : AI Assistant
	?§Î™Ö        : HSOD100U ?úÏ? Í∑∏Î¶¨???ïÏùòÎ•??∞Î•∏ ?êÏùµÍ≥ÑÏÇ∞??Ï°∞Ìöå
	=============================================================
-->
  ...
  <div class="erp-container d-flex flex-column h-100 bg-white">
    ...
    <div class="erp-header d-flex justify-content-between align-items-center flex-shrink-0 border-bottom">
      <div class="fw-bold ps-1 text-dark d-flex align-items-center" style="font-size: 14px;">
        ...
        <span class="text-primary fw-bolder">?êÏùµÍ≥ÑÏÇ∞??(HACL030S)</span>
      </div>
    ...
    columns: [
      ...
      },
      {
        ...
        columns: [
          ...
          { title: "?? Í≥?, field: "camtr", width: 160, hozAlign: "right", formatter: "money", formatterParams: { precision: 0 }, cssClass: "bg-light-subtle fw-bold" },
      ...
      },
      {
        title: "??     Í∏?,
        columns: [
          { title: "Í∏? ??, field: "bamtl", width: 160, hozAlign: "right", formatter: "money", formatterParams: { precision: 0 } },
          { title: "?? Í≥?, field: "bamtr", width: 160, hozAlign: "right", formatter: "money", formatterParams: { precision: 0 }, cssClass: "bg-light-subtle fw-bold" },
...
const excel = () => grid?.download("xlsx", `?êÏùµÍ≥ÑÏÇ∞??${searchForm.yy}${searchForm.mm}.xlsx`)
