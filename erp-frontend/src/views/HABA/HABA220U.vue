<!--
	...
	작성일자	: 2025.02.24
	작성자	    : AI Assistant
	설명        : 계정과목 및 거래처별 기초 잔액(이월/당월) 등록 및 관리
	=============================================================
-->
	...
	<div class="erp-container">
			...
			<div class="card border shadow-sm bg-white overflow-hidden">
				<div class="card-body p-2 bg-light">
					<div class="d-flex align-items-center flex-wrap gap-3">
						...
						<div class="d-flex align-items-center">
							<span class="erp-label">거 래 처</span>
							<div class="d-flex align-items-center gap-1">
		...
		<div class="p-2 pb-0 flex-shrink-0">
			...
			<div class="px-2 py-1 text-muted" style="font-size: 11px;">
				<i class="bi bi-info-circle me-1"></i> 이월 자료는 전기이월 잔액을, 당월 자료는 당월 기초 발생 금액을 의미합니다.
			</div>
		</div>
...
const save = async () => {
	...
	try {
		...
		else { vAlert('정상으로 저장 되었습니다.'); search(); initialize() }
...
function openHelp(type: string) {
	...
	if (type.includes('CUST') && (!searchForm.acctcd && !masterForm.acctcd)) return vAlert("계정과목을 우선 선택해 주십시요.")
	...
	if (mainGridRef.value) {
		mainGrid = new Tabulator(mainGridRef.value, {
			...
			columns: [
				...
				{ title: "차 변", field: "col7", width: 140, hozAlign: "right", formatter: "money", formatterParams: { precision: 0 }, bottomCalc: "sum" },
				{ title: "대 변", field: "col8", width: 140, hozAlign: "right", formatter: "money", formatterParams: { precision: 0 }, bottomCalc: "sum" },
				{ title: "잔 액", field: "col9", width: 140, hozAlign: "right", formatter: "money", formatterParams: { precision: 0 }, bottomCalc: "sum", cssClass: "fw-bold text-primary" }
			],
