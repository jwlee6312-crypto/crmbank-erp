			...
			<div class="card border shadow-sm bg-white overflow-hidden">
				...
				<table class="erp-table-full small">
					...
					<tbody>
						...
						<tr>
							<th class="text-center bg-light-subtle border-end">어음종류</th>
							<td class="bg-white border-end px-2 py-1">
							...
							<th class="text-center bg-light-subtle border-end">부도여부</th>
							<td class="bg-white px-2 py-1">
						...
						<tr>
							<th class="text-center bg-light-subtle border-end">받은거래처</th>
							<td class="bg-white border-end px-2 py-1" colspan="3">
								<div class="input-group input-group-sm" style="max-width: 350px;">
									...
									<input v-model="masterForm.custnm" type="text" class="form-control" @keydown.enter="openHelp" />
...
const fetchOptions = async () => {
	try {
		// 어음종류 (150)
		const resKind = await api.post('/api/ha00/HA00_00P_STR', { gubun: 'E0', cmpycd: ' ', search: '150' })
	...
	if (mainGridRef.value) {
		mainGrid = new Tabulator(mainGridRef.value, {
			...
			columns: [
				...
				{ title: "발행은행", field: "col1", width: 150 },
				...
				{ title: "종류", field: "col7", width: 100, hozAlign: "center" },
				{ title: "유형", field: "COL9", width: 100, hozAlign: "center" },
				{ title: "부도", field: "col14", width: 60, hozAlign: "center" },
				{ title: "사용", field: "col13", width: 60, hozAlign: "center", formatter: "tickCross" }
			],
			rowClick: (e, row) => {
				const d = row.getData()
