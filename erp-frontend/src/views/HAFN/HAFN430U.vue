<!--
	...
	작성일자	: 2025.02.24
	작성자	    : AI Assistant
	설명        : 만기 받을어음을 조회하여 입금 전표를 자동으로 생성
	=============================================================
-->
			...
			<div class="card border shadow-sm overflow-hidden bg-light">
				<table class="erp-table-full" style="table-layout: fixed;">
					...
					<tbody>
						...
						<tr>
							<th class="text-center border-end border-top">입금계정</th>
							...
							<th class="text-center border-end border-top">입금구좌</th>
						...
						<tr>
							...
							<th class="text-center border-end border-top bg-warning-subtle">총 입금액</th>
		...
		<div class="flex-grow-1 overflow-hidden p-2 d-flex flex-column">
			<div class="card border shadow-sm flex-grow-1 overflow-hidden d-flex flex-column bg-white">
				<div class="card-header py-1 px-2 bg-light d-flex justify-content-between align-items-center border-bottom text-secondary">
					<span class="fw-bold small"><i class="bi bi-list-check me-1"></i> 발행 대상 받을어음 리스트 (체크하여 선택)</span>
				</div>
...
const save = async () => {
	...
	if (!voucherForm.acctcd) return vAlert('입금계정을 선택하십시오.')
	if (!voucherForm.mgtno) return vAlert('입금구좌를 선택하십시오.')
