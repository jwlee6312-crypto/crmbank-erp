<template>
  ...
  <div class="hsba830u-wrapper d-flex flex-column h-100 bg-white p-0">
    <!-- 🚀 1. 상단 액션 바 -->
    ...
    <div class="erp-footer bg-dark text-white py-2 px-4 shadow-lg sticky-bottom">
      <div class="row align-items-center">
        ...
        <div class="col-md-6 text-end">
          <span class="fs-5 fw-light">총 미지급금 합계: <span class="fw-bold text-white ms-2">{{ formatNumber(totalPayableSum) }}</span></span>
        </div>
      </div>
    </div>
  </div>
...
<style scoped>
.hsba830u-wrapper { height: 100%; overflow: hidden; font-family: 'Pretendard', sans-serif; }
