<template>
  ...
  <div class="hsba280u-wrapper d-flex flex-column h-100 bg-white p-0 overflow-hidden text-start">
    <!-- 🚀 1. 상단 액션 바 -->
...
.erp-main-grid { height: 500px !important; flex-shrink: 0 !important; }
