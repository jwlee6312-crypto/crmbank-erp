...
<template>
	...
	<div class="hsst180s-wrapper d-flex flex-column h-100 bg-white p-0">
		...
		<div class="erp-footer bg-dark text-white py-2 px-4 shadow-lg sticky-bottom flex-shrink-0">
			<div class="row align-items-center w-100">
				<div class="col-md-2 small">조회 인원: <span class="fw-bold text-info">{{ rowCount }}</span> 명</div>
...
const handleExcel = () => mainGrid?.download("xlsx", "영업사원별판매현황.xlsx")
