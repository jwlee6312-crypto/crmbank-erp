<!--	=============================================================
	...
	?ëÏÑ±?ºÏûê	: 2025.02.24
	?ëÏÑ±??    : AI Assistant
	?§Î™Ö        : Î∂Ä?úÎ≥Ñ ?àÏÇ∞ ?ÄÎπ??§Ï†Å/?îÏï° ?ÑÌô© Ï°∞Ìöå
	=============================================================
-->
	...
	<div class="erp-container d-flex flex-column h-100 bg-white">
		...
		<div class="erp-header d-flex justify-content-between align-items-center border-bottom bg-white py-2 px-3 sticky-top shadow-sm flex-shrink-0">
			<div class="fw-bold text-dark d-flex align-items-center" style="font-size: 14px;">
				...
				<span class="text-primary fw-bolder">?àÏÇ∞?ÑÌô© (HABG210S)</span>
			</div>
...
const excel = () => {
	mainGrid?.download("xlsx", `?àÏÇ∞?ÑÌô©_${searchForm.deptnm}_${searchForm.bugtym}.xlsx`)
}
	...
	if (mainGridRef.value) {
		mainGrid = new Tabulator(mainGridRef.value, {
			...
			columns: [
				...
				{ title: "?àÏÇ∞Î™?, field: "bugtnm", widthGrow: 1 },
				{ title: "?àÏÇ∞Í∏àÏï°", field: "bugtamt", widthGrow: 1, hozAlign: "right", formatter: "money", formatterParams: { precision: 0 }, bottomCalc: "sum" },
				{ title: "?§Ï†ÅÍ∏àÏï°", field: "rsltamt", widthGrow: 1, hozAlign: "right", formatter: "money", formatterParams: { precision: 0 }, bottomCalc: "sum" },
				{ title: "?îÏï°", field: "balamt", widthGrow: 1, hozAlign: "right", formatter: "money", formatterParams: { precision: 0 }, bottomCalc: "sum" },
				{ title: "ÏßëÌñâ??%)", field: "rate", widthGrow: 1, hozAlign: "right" }
			]
		})
	}
