...
onMounted(() => {
	if (mainGridRef.value) {
		const commonWidth = 85; // 평균값으로 동일하게 지정
		...
		mainGrid = new Tabulator(mainGridRef.value, {
			...
			columns: [
				...
				{ title: "예산명", field: "bugtnm", width: 150, hozAlign: "left", formatter: "plaintext", frozen: true },
				{
					title: "상반기",
					columns: [
						{ title: "1월", field: "M01", width: commonWidth },
						{ title: "2월", field: "M02", width: commonWidth },
						{ title: "3월", field: "M03", width: commonWidth },
						{ title: "4월", field: "M04", width: commonWidth },
						{ title: "5월", field: "M05", width: commonWidth },
						{ title: "6월", field: "M06", width: commonWidth },
					]
				},
				{
					title: "하반기",
					columns: [
						{ title: "7월", field: "M07", width: commonWidth },
						{ title: "8월", field: "M08", width: commonWidth },
						{ title: "9월", field: "M09", width: commonWidth },
						{ title: "10월", field: "M10", width: commonWidth },
						{ title: "11월", field: "M11", width: commonWidth },
						{ title: "12월", field: "M12", width: commonWidth },
					]
				},
				{ title: "합계", field: "TOTAL", width: 110, cssClass: "bg-light fw-bold text-primary", bottomCalc: "sum", bottomCalcFormatter: "money", bottomCalcFormatterParams: { precision: 0 } }
			],
			columnCalcs: "both"
		})
	}
