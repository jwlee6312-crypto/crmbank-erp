<template>
  ...
  <div class="hpcl230s-wrapper d-flex flex-column h-100 bg-white p-0">
    <!-- 🚀 1. 상단 액션 바 -->
...
const fetchList = async () => {
  ...
  try {
    const res = await api.post('/api/hpcl/HPCL_230S_STR', {
...
<style scoped>
.hpcl230s-wrapper { height: 100%; overflow: hidden; font-family: 'Pretendard', sans-serif; background-color: #f4f7fa !important; }
