<template>
  ...
  <div class="hpba820u-wrapper d-flex flex-column h-100 bg-white p-0">
    <!-- 🚀 1. 상단 액션 바 -->
    ...
    <div class="erp-footer bg-dark text-white py-2 px-4 shadow-lg sticky-bottom">
      <div class="row align-items-center w-100">
        ...
        <div class="col-md-8 text-end text-muted small">
          <i class="bi bi-info-circle me-1"></i> 외주가공 건으로 출고된 거래처의 재고 수량을 포함하여 입력하십시오.
        </div>
      </div>
    </div>
...
<style scoped>
.hpba820u-wrapper { height: 100%; overflow: hidden; font-family: 'Pretendard', sans-serif; background-color: #f4f7fa !important; }
